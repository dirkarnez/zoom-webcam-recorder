...
# listImg = os.listdir("D:/Code Projects/Real-Time_Background_remover/BackgroundImages/")
# imgList = [] #list containing all background images
# for imgPath in listImg:
#     img = cv2.imread(f'D:/Code Projects/Real-Time_Background_remover/BackgroundImages/{imgPath}')
#     imgList.append(img)
# print(imgList)
# indexImg = 0
...
while True:
    ...
    #         indexImg +=1
    # elif
    if key == ord('q'): #if 'q' break out of loop
        break